...
<p>This automated e-mail was sent to inform you that a recurring payment <strong>expired</strong>, related to your "[[+product.name]]" subscription. (Subscription ID: [[+subscription.sub_id]]).</p>
<p>As a result of that, your account has not been updated to a new expiry date and you may have lost access to the product you subscribed to. You may need to re-subscribe if you want to gain access again. </p>
